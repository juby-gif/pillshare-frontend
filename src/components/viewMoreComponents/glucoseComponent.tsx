...
const GlucoseViewMoreComponent = (props:IProps):JSX.Element =>{
        ...
        <div id="app" style={{height: "100%"}}>
            <div id="outer-container" style={{height: "100%"}}>
                ...
                <div className="" id="page-wrap" style={{height: "100%",overflow:"auto"}}>
                    ...
                    <h3 style={{textAlign: "center"}} className="mt-3 display-3">GLUCOSE DEMOGRAPHICS</h3>
                        ...
                        <CardDeck style={{margin: "auto",width: "65%",}}>
                            <Card className="mb-4 text-center" style={{ color:"#fff",backgroundColor:"rgb(102,0,0)",minWidth: '15rem',maxWidth:'15rem',borderRadius:"18px 18px 18px 18px" }}>
                                <Card.Body>
                                    <Row className="mb-2">
                                        <Col>
                                            <Card.Subtitle style={{fontSize:"1.3rem"}}><b>High (mg/dL)</b></Card.Subtitle>
                                        </Col>
                                    </Row>
                                    <Row>
                                        <Col>
                            ...
                            <Card className="mb-4 text-center" style={{ color:"#fff",backgroundColor:"#6b6d0b",minWidth: '15rem',maxWidth:'15rem',borderRadius:"18px 18px 18px 18px" }} >
                                <Card.Body>
                                    <Row className="mb-2">
                                        <Col>
                                            <Card.Subtitle style={{fontSize:"1.3rem"}}><b>Average (mg/dL)</b></Card.Subtitle>
                                        </Col>
                                    </Row>
                                    <Row>
                                        <Col>
                            ...
                            <Card className="mb-4 text-center" style={{ color:"#fff",backgroundColor:"#3f00d1",minWidth: '15rem',maxWidth:'15rem',borderRadius:"18px 18px 18px 18px" }} >
                                <Card.Body>
                                    <Row className="mb-2">
                                        <Col>
                                            <Card.Subtitle style={{fontSize:"1.3rem"}}><b>Low (mg/dL)</b></Card.Subtitle>
                                        </Col>
                                    </Row>
                                    <Row>
                                        <Col>
...
export default GlucoseViewMoreComponent;