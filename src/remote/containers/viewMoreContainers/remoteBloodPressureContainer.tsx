...
import BloodPressureViewMoreComponent from '../../components/viewMoreComponents/remoteBloodPressureComponent';
import { REMOTE_PAYLOAD } from '../../../constants';
import { getRemoteBloodPressureData } from '../../API/remoteBloodPressureDataAPI';
...
export default class BloodPressureViewMoreContainer extends Component<IProps,StateProps>{
    ...
    componentDidMount(){
      ...
      if(OBJ.user_id !== null){
        getRemoteBloodPressureData(OBJ.user_id,onSuccessCallBack,onFailureCallBack);
      }
    }
